                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <div>
                            ...
                            <p class="mt-2 text-lg text-slate-600">
                                Terus tingkatkan keahlian Anda. Anda sedang bersemangat! 🚀
                            </p>
                        </div>
                        <!-- Quick Stat Pills -->
                        <div class="flex flex-wrap gap-2 sm:gap-3 pt-4">
                            <div class="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200">
                                ...
                                <span class="text-sm font-bold text-emerald-700">{{ $completedSwaps }} Pertukaran Selesai</span>
                            </div>
                            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-200">
                                ...
                                <span class="text-sm font-bold text-blue-700">{{ $acceptedRequests }} Kecocokan Aktif</span>
                            </div>
                            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-200">
                                ...
                                <span class="text-sm font-bold text-amber-700">{{ $pendingRequests }} Menunggu</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-linear-to-br from-indigo-50 to-blue-50 rounded-2xl p-6 border border-indigo-200/50 shadow-sm">
                        <div class="flex items-start justify-between mb-4">
                            <div>
                                <p class="text-xs font-bold uppercase tracking-wider text-slate-600 mb-1">Status Profil</p>
                        ...
                        <p class="text-sm text-slate-600 mb-4">Keahlian Ditawarkan: {{ $offeredSkills->count() }} | Keahlian Ingin Dipelajari: {{ $wantedSkills->count() }}</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="font-fraunces text-3xl font-bold text-slate-900">Permintaan Menunggu Tanggapan Anda</h2>
                        <p class="mt-1 text-slate-600">{{ $pendingRequests }} permintaan menunggu</p>
                    </div>
                ...
                @if($pendingRequests > 0)
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <p class="text-center text-slate-600">Permintaan pertukaran yang menunggu akan muncul di sini.</p>
                    </div>
                @else
                    <x-empty-state title="Semua sudah selesai!" description="Tidak ada permintaan yang menunggu. Telusuri kecocokan baru untuk mulai belajar." variant="compact">
                        <x-slot:icon>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <section>
                        <div class="mb-6">
                            <h2 class="font-fraunces text-2xl font-bold text-slate-900">Perjalanan Belajar Anda</h2>
                            <p class="mt-1 text-slate-600">Metrik utama dan pencapaian</p>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Total Pertukaran</p>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-xs font-bold text-slate-600">Tingkat Keberhasilan: {{ $successRate }}%</span>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Peringkat Anda</p>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-xs font-bold text-amber-600">Berdasarkan {{ $user->received_ratings_count }} pertukaran</span>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Keahlian Ditawarkan</p>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-xs font-bold text-blue-600">{{ $wantedSkills->count() }} keahlian ingin dipelajari</span>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Item Portofolio</p>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-xs font-bold text-indigo-600">{{ $totalPortfolioViews }} total tayangan</span>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h2 class="font-fraunces text-2xl font-bold text-slate-900">Aktivitas Terbaru</h2>
                                <p class="mt-1 text-slate-600">Pembaruan komunitas dari interaksi terbaru</p>
                            </div>
                        </div>
                        ...
                        @else
                            <x-empty-state title="Tidak ada aktivitas terbaru" description="Pembaruan komunitas akan muncul di sini." variant="compact">
                                <x-slot:icon>
                ...
                <div class="space-y-8">
                    ...
                    <section class="bg-linear-to-br from-indigo-600 to-blue-600 rounded-2xl p-6 shadow-lg shadow-indigo-600/20 text-white">
                        <h2 class="font-fraunces text-xl font-bold mb-6">Tindakan Cepat</h2>
                        <div class="space-y-3">
                            <a href="{{ route('matches.index') }}" class="flex items-center justify-between p-3 rounded-xl hover:bg-white/10 transition-colors group">
                                <span class="font-medium">Telusuri Kecocokan</span>
                            ...
                            <a href="{{ route('skills.edit') }}" class="flex items-center justify-between p-3 rounded-xl hover:bg-white/10 transition-colors group">
                                <span class="font-medium">Kelola Keahlian</span>
                                <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
                            </a>
                    ...
                    <section class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="font-fraunces text-xl font-bold text-slate-900">Ringkasan Keahlian</h2>
                        ...
                        @if($offeredSkills && count($offeredSkills) > 0)
                            <div class="space-y-4">
                                <!-- Offering Skills -->
                                <div>
                                    <p class="text-xs font-bold uppercase tracking-wider text-slate-600 mb-3">Keahlian yang Anda Tawarkan</p>
                                ...
                                @if($wantedSkills && count($wantedSkills) > 0)
                                    <div>
                                        <p class="text-xs font-bold uppercase tracking-wider text-slate-600 mb-3">Keahlian yang Ingin Anda Pelajari</p>
                                        <div class="flex flex-wrap gap-2">
                        ...
                        @else
                            <x-empty-state title="Tambahkan keahlian pertama Anda" description="Mulai dengan menambahkan keahlian yang dapat Anda tawarkan atau ingin pelajari." variant="compact">
                                <x-slot:icon>
                                ...
                                <x-slot:primaryAction>
                                    <a href="{{ route('skills.edit') }}" class="text-xs text-indigo-600 hover:text-indigo-700 font-bold mt-2 inline-block">Mulai →</a>
                                </x-slot:primaryAction>
                            </x-empty-state>
                        @endif
                    </section>
                    ...
                    <section class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <h2 class="font-fraunces text-xl font-bold text-slate-900 mb-6">Denyut Komunitas</h2>
                        <div class="space-y-4">
                            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50">
                                <span class="text-sm text-slate-600">Total Anggota Komunitas</span>
                                <span class="font-bold text-lg text-slate-900">{{ $communityStatistics['total_users'] }}</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50">
                                <span class="text-sm text-slate-600">Keahlian di Platform</span>
                                <span class="font-bold text-lg text-slate-900">{{ $communityStatistics['total_skills'] }}</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-50">
                                <span class="text-sm text-slate-600">Pertukaran Selesai</span>
