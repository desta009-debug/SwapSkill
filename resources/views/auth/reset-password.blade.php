...
<head>
    ...
    <title>Reset Password - SwapSkill</title>
        ...
        <div class="mx-auto grid min-h-[92vh] max-w-5xl overflow-hidden rounded-[28px] border border-white/10 bg-white/5 shadow-[0_20px_80px_rgba(76,29,149,0.28)] backdrop-blur-xl lg:grid-cols-2">
            <div class="relative hidden overflow-hidden bg-linear-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] p-8 text-white lg:flex lg:flex-col lg:justify-between">
                ...
                <div class="relative z-10 max-w-md">
                    ...
                    <p class="mt-4 text-sm leading-7 text-white/70">
                        Gunakan password baru yang aman supaya akun kamu tetap terlindungi.
                    </p>

                    <div class="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4">
                        <p class="text-sm text-white/60">Tips</p>
                        <h3 class="mt-1 text-base font-bold text-white">Buat password kuat</h3>
                        <p class="mt-2 text-sm leading-6 text-white/55">
                            Pakai kombinasi huruf, angka, dan karakter unik.
                        </p>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-center bg-white/5 p-6 sm:p-8">
                <div class="w-full max-w-md">
                    ...
                    <div class="mb-6">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-violet-300">Reset password</p>
                        <h2 class="mt-2 text-3xl font-extrabold tracking-tight text-white">Atur password baru</h2>
                        <p class="mt-2 text-sm leading-6 text-white/55">
                            Masukkan email dan password baru kamu untuk menyelesaikan reset.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                        ...
                        <div>
                            <label for="password" class="mb-2 block text-xs font-medium uppercase tracking-widest text-white/50">Password Baru</label>
                        ...
                        <div>
                            <label for="password_confirmation" class="mb-2 block text-xs font-medium uppercase tracking-widest text-white/50">Konfirmasi Password Baru</label>
